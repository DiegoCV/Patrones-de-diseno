 ...
 */
public class RobotHamburguesa implements IRobot {
    ...
    private void armarHamburguesa() {
        System.out.println("Armando Hamburguesa");
    }

    private void revisandoHamburguesa() {
        System.out.println("Hamburguesa Revisada");
    }
    ...
    private void llamarMetodo(Integer i) {
        switch(i){
            ...
            case 2:
                ...
                break;
            case 3:
                this.armarHamburguesa();
                break;
            case 4:
                this.revisandoHamburguesa();
                break;
            default:
